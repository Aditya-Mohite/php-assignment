...
{
    resend($num,$email);
    $str="<script> var i='{$local_url}/verification.php?message=Please register&email=emailname';window.location.href='./verification.php'; </script>";
 echo $str;
}
else
{
...
{
   echo "<script> var i='{$local_url}/register.php?message=Please register';window.location.href='./register.php'; </script>";
}
