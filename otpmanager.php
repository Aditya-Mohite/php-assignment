...
else if($result->num_rows >0 && $row['verify']=='1')
{
    ...
    {
     echo "<script> var i='{$local_url}/Home.php?massage=You are successfully logedin';window.location.href='./Home.php'; </script>";
    }
    else
    {
         echo "<script>
...
{
$str="<script> var i='{}/verification.php?massage=Incorrect OTP&email={$email}';window.location.href=i; </script>";
 echo $str;
}
?>
