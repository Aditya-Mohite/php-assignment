...
{
echo "<script> var i='{}/Home.php?massage=You are successfully logedin';window.location.href='./Home.php'; </script>";
}
?>
<html>
  <head>
        ...
        <div class="col-md-6">
            <div class="card">
                <form action="checklogin.php" method="post" class="box">
                    ...
                    <input type="submit" name="Login" value="Login" href="./Home.php">
                </form>
            </div>
        </div>
    </div>
